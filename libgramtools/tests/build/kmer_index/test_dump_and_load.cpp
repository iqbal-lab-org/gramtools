...
TEST(DumpKmers, GivenTwoKmers_CorrectAllKmersStructure) {
  ...
  bool result = all_kmers == sdsl::int_vector<3>{1, 2, 3, 4, 2, 4, 3, 4} or
                all_kmers == sdsl::int_vector<3>{2, 4, 3, 4, 1, 2, 3, 4};
  EXPECT_TRUE(result);
}
...
TEST(DeserializeNextStats,
     GivenOneSearchStateWithThreePaths_CorrectlyIndexedKmerStats) {
...
TEST(DeserializeNextStats,
     GivenTwoSearchStateWithMultiplePaths_CorrectlyIndexedKmerStats) {
...
TEST(DumpAndLoadIndex, TwoPathsWithMultipleElements) {
  ...
  KmerIndex kmer_index = {
      {{1, 2, 3, 4},
       SearchStates{
           SearchState{SA_Interval{6, 6}, VariantSitePath{VariantLocus{5, 1}},
                       VariantSitePath{}},
           SearchState{SA_Interval{7, 42},
                       VariantSitePath{VariantLocus{7, 3}, VariantLocus{5, 2}},
                       VariantSitePath{VariantLocus{9, ALLELE_UNKNOWN}}}}}};
  ...
  KmerIndex kmer_index = {
      {{1, 2, 3, 4},
       SearchStates{SearchState{
                        SA_Interval{6, 6},
                        VariantSitePath{VariantLocus{5, FIRST_ALLELE}},
                        VariantSitePath{VariantLocus{7, ALLELE_UNKNOWN}},
                    },
                    SearchState{
                        SA_Interval{7, 7},
                        VariantSitePath{VariantLocus{5, FIRST_ALLELE + 1}},
                    ...
                    SearchState{
                        SA_Interval{8, 8},
                        VariantSitePath{VariantLocus{5, FIRST_ALLELE + 1}},
                        VariantSitePath{VariantLocus{11, ALLELE_UNKNOWN},
