...
CovCount Genotyper::find_minimum_non_error_cov(double mean_pb_error, poisson_pmf_ptr poisson_prob) {
...
Genotyper::Genotyper(coverage_Graph const& cov_graph, SitesGroupedAlleleCounts const& gped_covs,
