...
allele_vector const GenotypedSite::get_unique_genotyped_alleles(
...
AlleleIds GenotypedSite::get_genotyped_haplogroups(
    allele_vector const& input_alleles, GtypedIndices const& input_gts) const {
  AlleleIds result;
