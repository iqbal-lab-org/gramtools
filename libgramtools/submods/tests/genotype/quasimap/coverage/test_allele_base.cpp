...
TEST(PbCovRecorder_NodeProcessing, ProcessExistingCovNode_CorrectlyUpdatedDummyCovNode){
    covG_ptr cov_node = boost::make_shared<coverage_Node>(
...
TEST_F(PbCovRecorder_TwoSitesNoNesting, ReadCoversTwoSites2_CorrectCoverageNodes) {
