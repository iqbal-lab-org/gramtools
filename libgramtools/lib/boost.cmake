...
ExternalProject_Add(boost
        ...
        CONFIGURE_COMMAND bash -c "cd ${CMAKE_CURRENT_BINARY_DIR}/src/boost_1_65_1 && ./bootstrap.sh --with-libraries=random,program_options,timer,system,filesystem --prefix=${CMAKE_CURRENT_BINARY_DIR}"
