...
class Genotyper:
    ...
    def _log_likelihood_heterozygous(
        ...
        return sum(
            [
                ...
                * (
                    1
                    + 0.5 * (allele_length1 + allele_length2 - non_zeros1 - non_zeros2)
                ),
    ...
    def _calculate_log_likelihoods(self):
        ...
        for (allele_number1, allele_number2) in itertools.combinations(
            ...
            non_zeros1 = allele1_length - self.allele_per_base_cov[
                allele_number1
            ].count(0)
            non_zeros2 = allele2_length - self.allele_per_base_cov[
                allele_number2
            ].count(0)
