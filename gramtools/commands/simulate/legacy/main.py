...
def setup_command_parser(common_parser, subparsers):
    ...
    parser.add_argument("--prg", help="", type=str, required=True)
    parser.add_argument("--output-fpath", "-o", help="", type=str, required=True)
    parser.add_argument("--max-num-reads", help="", type=int, default=None)
    parser.add_argument("--read-length", help="", type=int, default=20)
