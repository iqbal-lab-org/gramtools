...
from gramtools import genotyper
...
class TestGenotyper(unittest.TestCase):
    ...
    def test_singleton_alleles_and_coverage(self):
        ...
        self.assertEqual({0: 20}, genotyper.Genotyper._singleton_alleles_and_coverage(allele_combination_cov,
                                                                                      allele_groups_dict))
        allele_combination_cov['2'] = 42
        self.assertEqual({0: 20, 1: 42}, genotyper.Genotyper._singleton_alleles_and_coverage(allele_combination_cov,
                                                                                             allele_groups_dict))
    ...
    def test_coverage_of_one_haploid_allele(self):
        ...
        self.assertEqual(0, genotyper.Genotyper._coverage_of_one_haploid_allele(0, allele_combination_cov,
                                                                                allele_groups_dict))
        self.assertEqual(21, genotyper.Genotyper._coverage_of_one_haploid_allele(1, allele_combination_cov,
                                                                                 allele_groups_dict))
    ...
    def test_coverage_of_diploid_alleles(self):
        ...
        singleton_alleles_cov = genotyper.Genotyper._singleton_alleles_and_coverage(allele_combination_cov,
                                                                                    allele_groups_dict)
        self.assertEqual((25, 88), genotyper.Genotyper._coverage_of_diploid_alleles(0, 1, allele_combination_cov,
                                                                                    allele_groups_dict,
    ...
    def test_log_likelihood_heterozygous(self):
        ...
        self.assertEqual(-52.97,
                         round(genotyper.Genotyper._log_likelihood_heterozygous(100, 45, 40, 95, 0.01, 3, 3, 3, 3), 2))
        self.assertEqual(-152.97,
                         round(genotyper.Genotyper._log_likelihood_heterozygous(100, 45, 40, 95, 0.01, 3, 3, 2, 2), 2))
    ...
    def test_calculate_log_likelihoods(self):
        ...
        gtyper = genotyper.Genotyper(mean_depth, error_rate, allele_combination_cov, allele_per_base_cov,
                                     allele_groups_dict)
