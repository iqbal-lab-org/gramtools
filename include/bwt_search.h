...
csa_wt<wt_int<bit_vector,rank_support_v5<>>,2,2> csa_constr(std::string fname, std::string int_al_fname, std::string memory_log_fname, std::string csa_file, bool fwd);
